...
- 매수/매도/진입/타이밍 등 직접적 매매 유도 표현 절대 금지
- '~가 변수', '~여부 주목', '~흐름 확인 필요' 같은 관찰자 톤 사용
"""
                slot_examples = """
{
    "category": "AI · 기술",
    ...
    "main_story": "이번 주 엔비디아 투자 확대 소식에 국내 반도체주도 강세로 마감. 삼성전자·SK하이닉스는 엔비디아에 메모리를 납품하는 회사라 직접 수혜 가능성이 있어요. 다음 주 엔비디아 실적 발표 결과에 따라 월요일 분위기가 확 바뀔 수 있어요.",
    "watch_points": [
        "월요일 엔비디아 실적 발표 — 예상 상회 여부가 핵심 변수",
        "주말 사이 해외 AI 관련 뉴스 동향",
        "삼성전자·SK하이닉스 월요일 수급 변화"
    ],
    "related_stocks": ["삼성전자", "SK하이닉스", "한미반도체"],
    "mood": "positive",
    "market_outlook": "이번 주 강세 흐름이 월요일에도 이어질지 엔비디아 실적이 가늠자가 될 것으로 보여요. 기대치가 높은 만큼 결과에 따른 변동성도 클 수 있어요."
}"""
            else:  # sunday
                ...
                slot_examples = """
{
    ...
    "main_story": "주말 사이 미국 고용지표가 예상을 웃돌며 달러 강세. 달러 강세는 원화 약세로 이어져 외국인 수급에 영향을 줄 수 있어요. 내일 월요일 코스피는 환율 흐름에 따라 변동성이 커질 수 있어요.",
    "watch_points": [
        "월요일 달러/원 환율 — 1,380원 수준 유지 여부",
        "미국 선물 시장 밤사이 동향",
        "중국 증시 개장 반응"
    ],
    "related_stocks": ["삼성전자", "현대차", "POSCO홀딩스"],
    "mood": "neutral",
    "market_outlook": "달러 강세로 외국인 수급 영향이 예상돼요. 월요일 장 초반 환율 안정 여부가 시장 방향성의 핵심 변수가 될 것으로 보여요."
}"""
...
- watch_points는 2~4개
- 매수/매도/진입/타이밍/지금 사야/지금 팔아야 같은 직접적 매매 유도 표현 절대 금지
- 긍정/부정 판단이 불확실한 내용은 neutral로 처리하고 양면을 함께 서술
...
{{
    ...
    "market_outlook": "2문장 이내, 시장 흐름 관찰 중심 (매매 유도 표현 금지)"
}}
...
### 톤 & 스타일:
- **출근길(morning)**: "오늘 이거 주목해요!" 식의 관찰 포인트 제시
- **점심(noon)**: "지금 이렇게 흘러가고 있어요" 식의 현황 설명
- **퇴근(night)**: "내일 이게 변수가 될 수 있어요" 식의 흐름 전망
...
{{
    "category": "AI · 기술",
    "time_slot": "morning",
    "headline": "AI칩 수요 폭발, 반도체주 흐름 주목 📈",
    "main_story": "엔비디아 투자 소식이 전해지며 국내 반도체 수급 개선 기대감이 높아지고 있어요. 삼성전자·SK하이닉스가 엔비디아에 메모리를 납품하는 구조라 이 흐름과 연동되는 경향이 있어요.",
    "watch_points": [
        "삼성전자 오전장 흐름 확인",
        "SK하이닉스 수급 변화 여부",
        "해외 선물 영향도 체크"
    ...
    "mood": "positive",
    "market_outlook": "AI 수요 강세 흐름이 국내 반도체주에도 영향을 줄지 오전장 수급이 가늠자가 될 것으로 보여요."
}}
...
{{
    "category": "금융",
    "time_slot": "noon",
    "headline": "금리인상 신호에 금융주 약세... 오후는? 🤔",
    "main_story": "오전장 기준 금융주가 약세 흐름을 이어가고 있어요. 한은 발언 이후 시장 심리가 위축된 상태이며, 오후 해외 지표 발표가 변수로 작용할 수 있어요.",
    "watch_points": [
        "오후 미국 경제지표 발표 (2시 예정) 결과",
        "금융주 약세 지속 여부",
        "환율 변화 추적"
    ],
    "related_stocks": ["KB금융", "신한지주", "하나금융"],
    "mood": "negative",
    "market_outlook": "금리인상 우려로 금융주가 약세를 보이는 중이에요. 오후 미국 지표 결과가 분위기 전환의 변수가 될 수 있어요."
}}
...
{{
    ...
    "main_story": "오늘 유가 하락으로 에너지주가 약세로 마감했어요. 내일 OPEC+ 회의 결과에 따라 흐름이 바뀔 가능성이 있고, 밤사이 선물 동향도 주목할 필요가 있어요.",
    "watch_points": [
        "밤사이 WTI 유가 변화",
        "내일 OPEC+ 회의 결과",
        "국내 에너지주 연동 여부"
    ...
    "mood": "neutral",
    "market_outlook": "유가 약세 흐름이 이어지고 있지만, 내일 OPEC+ 회의 결과가 방향성을 바꿀 핵심 변수예요."
}}
...
### ❌ 절대 금지:
1. 딱딱한 "보고서" 톤
2. 불확실한 이슈를 일방적으로 긍정/부정으로 단정
3. 매수/매도/진입/타이밍/지금 사야/지금 팔아야 등 직접적 매매 유도 표현
4. 시간대 관계없이 같은 내용 반복

### ✅ 반드시 포함:
1. **시간대에 맞는 톤** (아침/점심/저녁 다름)
2. **Watch Points** (구체적 관찰 포인트 또는 주목 변수)
3. **변수 제시** (뭐가 바뀔 수 있나?)
4. **자연스러운 문체** (친구 조언 같은 느낌)
5. **관찰자 톤** (~가 변수, ~여부 주목, ~흐름 확인 필요)
    ...
    def save_category_briefing(self, db, briefing_data: dict, articles: list, slot: str = "morning"):
        ...
        try:
            ...
            new_briefing = Briefing(
                ...
                negative_points=[briefing_data.get("market_outlook", "")],
